/*=========================================================================
  ...
  Module:    TestVpxEncoderPushReceiveDisplayNV12.cxx
...
int TestVpxEncoderPushReceiveDisplayNV12(int argc, char* argv[])
{
...
#if WRITE_BITSTREAM
  std::ofstream file("cyl_nv12.vp9", std::ios::out | std::ios::binary);
#endif
  ...
  picture->SetPixelFormat(VTKPixelFormatType::VTKPF_NV12);
