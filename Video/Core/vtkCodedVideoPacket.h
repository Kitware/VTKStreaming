...
public:
   ...
   * either vtkCodedVideoPacket::SetSize or vtkCodedVideoPacket::AllocateCopy
   */
   ...
   * underlying buffer.
   */
  void ShallowCopy(vtkCodedVideoPacket* other);
  void AllocateCopy(vtkCodedVideoPacket* other);
  ///@}
