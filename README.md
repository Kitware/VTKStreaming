...
## Optional (For libvpx):
Acquire `nasm`. You may download binaries for linux, windows and mac from [nasm.us](https://nasm.us). If that link is down, try https://www.nasm.us/pub/nasm/stable/
