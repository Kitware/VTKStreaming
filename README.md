...
4. [examples/simple_videotoolbox_record.py](./examples/simple_videotoolbox_record.py) - Record a render window for later playback using Apple's VideoToolbox hardware encoder (macOS). This needs `ffplay` to playback the .h264 file.
